    ...
    <div className="flex items-center my-1 group cursor-pointer" style={{marginLeft:"-3rem"}} tabIndex="0">
        <div className="flex justify-end w-12 relative">
            <div className="flex relative mr-2">
                <div className="flex text-sm text-gray-900 group-hover:bg-gray-100 group-focus-within:bg-gray-200 p-1 rounded">
                    <PlusIcon />
                </div>
        ...
        <div className="flex items-center w-full">
            <div className="w-full h-1 group-hover:bg-gray-100 group-focus-within:bg-gray-200" />
        </div>
    </div>
);
