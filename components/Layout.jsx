...
const NavbarLink = props => (
    <a href={props.to} target={props.target} className="flex items-center gap-1 text-neutral-900 px-3 py-2 rounded-md hover:bg-yellow-100">
        {props.icon && (
...
const CreateNotebookButton = () => (
    <a href="./#new" target="_blank" className="flex items-center gap-2 bg-neutral-950 hover:bg-neutral-900 rounded-md px-3 py-2">
...
export const Layout = props => (
    <div className="">
        ...
        {/* Main content */}
        <div className="w-full max-w-6xl mx-auto px-12 py-2 md:py-8">
            {props.children}
        </div>
        {/* Footer */}
        <div className="w-full max-w-6xl mx-auto px-12 pt-8 pb-20">
            ...
            <div className="text-sm text-neutral-500">
                Designed by <a href="https://josemi.xyz" target="_blank" className="text-neutral-700 hover:text-neutral-900 font-medium underline">Josemi</a>. 
                Source code available on <a href={process.env.URL_REPOSITORY} target="_blank" className="text-neutral-700 hover:text-neutral-900 font-medium underline">GitHub</a>.
            </div>
        </div>
    </div>
);
