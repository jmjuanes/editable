...
import {BarsIcon, PlusIcon, renderIcon} from "@josemi-icons/react";
...
const NavbarLink = props => (
    <Link to={props.to} className="flex items-center gap-1 text-gray-800 px-3 py-2 rounded-md hover:bg-gray-200 no-underline">
        {props.icon && (
...
const CreateNotebookButton = props => (
    <div className="flex items-center gap-2 text-white bg-gray-800 hover:bg-gray-900 rounded-full px-4 py-2" onClick={props.onClick}>
                    ...
                    <div className="fixed sm:initial top-0 right-0 p-6 sm:p-0 hidden sm:block sm:w-full group-focus-within:block z-5">
                        <div className="flex flex-col sm:flex-row gap-3 sm:items-center rounded-md bg-white p-4 sm:p-0 w-72 sm:w-full">
                            <div className="pr-12 sm:pr-0 sm:flex sm:mx-auto">
                                <NavbarLink to="/dashboard" text="Dashboard" icon="grid" />
                                <NavbarLink to="/examples" text="Examples" icon="book" />
                            </div>
                            <div className="flex">
