...
const CreateNotebookButton = () => (
    <a href="./" target="_blank" className="flex items-center gap-2 bg-neutral-950 hover:bg-neutral-900 rounded-md px-3 py-2">
    ...
    <div className="">
        ...
        <div className="w-full max-w-6xl mx-auto px-12 pt-8 pb-20">
            ...
            <div className="text-sm">
                ...
                Source code available on <a href={process.env.URL_REPOSITORY} target="_blank" className="text-neutral-800 hover:text-neutral-900 font-medium underline">GitHub</a>.
            </div>
        </div>
    </div>
);
