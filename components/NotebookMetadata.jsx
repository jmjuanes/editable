    ...
    return (
        <div className="flex flex-wrap items-center gap-2 border border-gray-200 rounded-md p-2">
            {props.value.map((tag, index) => (
                <div className="flex items-center gap-2 pl-3 pr-2 py-2 bg-gray-200 rounded-full" key={index}>
                    <div className="flex items-center text-gray-600 text-xs leading-none">{tag}</div>
    ...
    return (
        <Modal title="Notebook Metadata" onClose={props.onClose}>
            ...
            <div className="flex justify-end select-none">
                <button className="flex items-center rounded-md p-3 bg-gray-900 hover:bg-gray-800 cursor-pointer " onClick={handleSubmit}>
